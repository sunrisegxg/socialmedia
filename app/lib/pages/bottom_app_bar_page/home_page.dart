...
class _HomePageState extends State<HomePage> {
  ...
  // Future<List<String>> fetchVideoUrlsFromDatabase() async {
  //   List<String> videoUrls = [];
  //   try {
  //     // Giả sử bạn có một collection tên là 'posts'
  //     QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('posts').get();
      
  //     for (var doc in snapshot.docs) {
  //       // Kiểm tra xem trường videoPost có tồn tại và không null
  //       if (doc['videoPost'] != null) {
  //         List<dynamic> videoPosts = doc['videoPost']; // Giả sử videoPost là một danh sách
  //         videoUrls.addAll(videoPosts.cast<String>()); // Thêm tất cả vào danh sách videoUrls
  //       }
  //     }
  //   } catch (e) {
                                  ...
                                  builder: (context, snapshot7) {
                                    ...
                                    return Padding(
                                      ...
                                      child: Column(children: [
                                        Center(
                                          child: isLoading ? const ShimmerUser() : Row(
                                            mainAxisAlignment:
                                                  ...
                                                  child: ListTile(
                                                    ...
                                                    subtitle: Row(
                                                      children: [
                                                        ...
                                                        postData['location'] == '' ? Container() : Container(
                                                        width: 188,
                                                        child: Text(
                                        ...
                                        isLoading ? const ShimmerCard() :Container(
